...
public class CourseMainModel : MainModel, IActiveTimeFrame
{
    ...
    /// <summary>
    ///     This is the team category list. Each team in a course will have their own category. Only the Admin will be able to
    ///     access all the categories
    /// </summary>
    [BsonElement("TeamCategoryList")]
    public TeamCategory[] TeamCategoryList { get; set; }

    /// <summary>
    ///     This is used to store the amount of teams, and will be helpful to know whether or not TeamCategoryIdList is up to
    ///     date
    /// </summary>
    [Required]
