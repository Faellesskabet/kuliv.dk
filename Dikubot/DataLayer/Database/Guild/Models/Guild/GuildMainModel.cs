...
public class GuildMainModel : MainModel
{
    ...
    [BsonElement("DiscordId")] public ulong DiscordId { get; set; }

    [BsonElement("CreatedAt")] public DateTimeOffset CreatedAt { get; set; }

    [BsonElement("Name")] public string Name { get; set; }

    [BsonElement("AFKTimeout")] public int AFKTimeout { get; set; }

    [BsonElement("IsEmbeddable")] public bool IsEmbeddable { get; set; }

    [BsonElement("IsWidgetEnabled")] public bool IsWidgetEnabled { get; set; }

    [BsonElement("DefaultMessageNotifications")]
    public DefaultMessageNotifications DefaultMessageNotifications { get; set; }

    [BsonElement("MfaLevel")] public MfaLevel MfaLevel { get; set; }

    [BsonElement("VerificationLevel")] public VerificationLevel VerificationLevel { get; set; }

    [BsonElement("ExplicitContentFilter")] public ExplicitContentFilterLevel ExplicitContentFilter { get; set; }

    [BsonElement("IconId")] public string IconId { get; set; }

    [BsonElement("IconUrl")] public string IconUrl { get; set; }

    [BsonElement("SplashId")] public string SplashId { get; set; }

    [BsonElement("SplashUrl")] public string SplashUrl { get; set; }

    [BsonElement("DiscoverySplashId")] public string DiscoverySplashId { get; set; }

    [BsonElement("DiscoverySplashUrl")] public string DiscoverySplashUrl { get; set; }

    [BsonElement("Available")] public bool Available { get; set; }

    [BsonElement("AFKChannelId")] public ulong? AFKChannelId { get; set; }

    [BsonElement("DefaultChannelId")] public ulong DefaultChannelId { get; set; }

    [BsonElement("EmbedChannelId")] public ulong? EmbedChannelId { get; set; }

    [BsonElement("WidgetChannelId")] public ulong? WidgetChannelId { get; set; }

    [BsonElement("SystemChannelId")] public ulong? SystemChannelId { get; set; }

    [BsonElement("RulesChannelId")] public ulong? RulesChannelId { get; set; }

    [BsonElement("PublicUpdatesChannelId")]
    public ulong? PublicUpdatesChannelId { get; set; }

    [BsonElement("OwnerId")] public ulong OwnerId { get; set; }

    [BsonElement("ApplicationId")] public ulong? ApplicationId { get; set; }

    [BsonElement("VoiceRegionId")] public string VoiceRegionId { get; set; }


    public IAudioClient AudioClient => _guildImplementation.AudioClient;

    //set { }
    public IRole EveryoneRole => _guildImplementation.EveryoneRole;

    //set { }
    public IReadOnlyCollection<GuildEmote> Emotes => _guildImplementation.Emotes;

    //set { }
    public IReadOnlyCollection<string> Features => (IReadOnlyCollection<string>)_guildImplementation.Features;

    //set { }
    public IReadOnlyCollection<IRole> Roles => _guildImplementation.Roles;
    //set { }

    public PremiumTier PremiumTier => _guildImplementation.PremiumTier;

    //set { }
    [BsonElement("BannerId")] public string BannerId { get; set; }

    [BsonElement("BannerUrl")] public string BannerUrl { get; set; }

    [BsonElement("VanityURLCode")] public string VanityURLCode { get; set; }

    public SystemChannelMessageDeny SystemChannelFlags => _guildImplementation.SystemChannelFlags;
    ...
    [BsonElement("MaxPresences")] public int? MaxPresences { get; set; }

    [BsonElement("MaxMembers")] public int? MaxMembers { get; set; }

    [BsonElement("MaxVideoChannelUsers")] public int? MaxVideoChannelUsers { get; set; }
    ...
    [BsonElement("PreferredLocale")] public string PreferredLocale { get; set; }


    public CultureInfo PreferredCulture => _guildImplementation.PreferredCulture;
    //set { }
}