...
{
    public GuildMongoService(Database database, SocketGuild guild) : base(database, guild)
    {
    }
    ...
    public bool Exists(GuildMainModel mainModelIn)
    {
    ...
    /// <return>A Model.</return>
    public GuildMainModel Get(ulong discordId)
    {
        return Get(model => model.DiscordId == discordId);
    }
