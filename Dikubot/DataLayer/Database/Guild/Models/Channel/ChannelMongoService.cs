...
{
    protected ChannelMongoService(Database database, SocketGuild guild)
        : base(database, guild)
    {
    }

    /// <Summary>
    ///     Inserts a ChannelModel in the collection. If a ChannelModel with the same ID or discordID
