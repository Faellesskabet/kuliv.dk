...
{
    public CategoryChannelMongoService(Database database, SocketGuild guild) : base(database, guild)
    {
    }
    ...
    {
        CategoryChannelMainModel _categoryChannel = new CategoryChannelMainModel();
        ...
        foreach (Overwrite overwrite in categoryChannel.PermissionOverwrites)
    ...
    {
        GuildChannelProperties categoryChannelProperties = new GuildChannelProperties();
