...
{
    public VoiceChannelMongoService(Database database, SocketGuild guild) : base(database, guild)
    {
    }
    ...
    {
        VoiceChannelMainModel _voiceChannel = new VoiceChannelMainModel();
        ...
        foreach (Overwrite overwrite in voiceChannel.PermissionOverwrites)
