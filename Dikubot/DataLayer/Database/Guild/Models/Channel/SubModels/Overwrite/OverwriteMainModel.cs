...
namespace Dikubot.DataLayer.Database.Guild.Models.Channel.SubModels.Overwrite
{
    public class OverwriteMainModel : MainModel
    {
        public OverwriteMainModel(global::Discord.Overwrite? overwrite = null)
        {
            if (overwrite != null)
        ...
        public global::Discord.Overwrite ToOverwrite()
        {
            ...
            var overwrite = new global::Discord.Overwrite(
        ...
        public void ToModel(global::Discord.Overwrite overwrite)
        {
        ...
        public string ToString(string fmt)
        {
            ...
            {
                case "A":
                    return string.Format("R:{0}, G:{1}, B:{2}",Type,
                        DiscordId, Connect,Speak,AddReactions,
                        AttachFiles,DeafenMembers,EmbedLinks,ManageChannel,ManageMessages,ManageMessages,ManageRoles,ManageWebhooks,MentionEveryone,
                        MoveMembers,MuteMembers,SendMessages,ViewChannel,CreateInstantInvite,ReadMessageHistory,UseExternalEmojis,UseVAD,SendTTSMessages);
                default:
