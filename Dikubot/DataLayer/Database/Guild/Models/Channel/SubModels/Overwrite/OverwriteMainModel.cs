...
public class OverwriteMainModel : MainModel
{
    ...
    public global::Discord.Overwrite ToOverwrite()
    {
        ...
        global::Discord.Overwrite overwrite = new global::Discord.Overwrite(
        ...
        switch (fmt.ToUpperInvariant())
        {
            case "A":
                return string.Format("R:{0}, G:{1}, B:{2}", Type,
                    ...
                    AttachFiles, DeafenMembers, EmbedLinks, ManageChannel, ManageMessages, ManageMessages, ManageRoles,
                    ManageWebhooks, MentionEveryone,
                    MoveMembers, MuteMembers, SendMessages, ViewChannel, CreateInstantInvite, ReadMessageHistory,
                    UseExternalEmojis, UseVAD, SendTTSMessages);
            default:
