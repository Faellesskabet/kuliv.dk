...
public class UserRoleModel : IActiveTimeFrame
{
    ...
    /// <returns>
    ///     Returns true if the object is an instance of UserRoleModel and if the RoleId is the same for both objects,
    ///     otherwise it will return false
    /// </returns>
    public override bool Equals(object obj)
    {
        return obj is UserRoleModel model && model.RoleId == RoleId;
    }
