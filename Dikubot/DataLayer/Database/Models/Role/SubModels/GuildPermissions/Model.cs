...
namespace Dikubot.Database.Models.Role.SubModels
{
    ...
    {
        public GuildPermissionsModel(GuildPermissions? guildPermissions = null)
        {
        ...
        public GuildPermissions ToGuildPermission()
        {
        ...
        public void ToModel(GuildPermissions? guildPermissions)
        {
