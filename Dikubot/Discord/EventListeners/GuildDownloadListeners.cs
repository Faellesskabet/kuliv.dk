...
public class GuildDownloadListeners
{
    ...
    public GuildDownloadListeners(DiscordSocketClient discordSocketClient, IGuildMongoFactory guildMongoFactory,
        IPermissionServiceFactory permissionServiceFactory, Database database)
    {
    ...
    public async Task UpdateGuildOnChange(SocketGuild outGuild, SocketGuild inGuild)
    {
        ...
        PermissionsService permissionsServices = _permissionServiceFactory.Get(inGuild);
